...
TEST_CASE("FootSoldier"){
    ...
    board.move(1,{5,2},WarGame::Board::MoveDIR::Up);
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
    ...
    board.move(1,{0,5},WarGame::Board::MoveDIR::Right);
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));

    board.move(2,{7,5},WarGame::Board::MoveDIR::Left);
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
}
...
TEST_CASE("FootCommander"){
    ...
    board.move(2,{7,1},WarGame::Board::MoveDIR::Right);
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));

    board.move(1,{0,5},WarGame::Board::MoveDIR::Left);
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
...
TEST_CASE("Sniper"){
    ...
    board.move(2,{7,5},WarGame::Board::MoveDIR::Right);
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
...
TEST_CASE("SniperCommander"){
    ...
    board.move(2,{7,1},WarGame::Board::MoveDIR::Left);
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
...
TEST_CASE("FootSoldier and Sniper"){
	...
	CHECK(board[{0, 5}]->get_health_points() == 100);
	CHECK(board[{7, 1}]->get_health_points() == 100);
	CHECK(board[{7, 7}]->get_health_points() == 100);
...
TEST_CASE("FootSoldier, Sniper, FootCommander"){
    ...
    board.move(2,{7,6},WarGame::Board::MoveDIR::Right);
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
}
...
TEST_CASE("FootSoldier, Sniper, FootCommander, SniperCommander"){
    ...
    board.move(1,{0,1},WarGame::Board::MoveDIR::Up);//1,1
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
    
    board.move(2,{7,1},WarGame::Board::MoveDIR::Left);//7,0
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
  
    board.move(1,{5,2},WarGame::Board::MoveDIR::Down);//4,2
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
    
    board.move(2,{7,5},WarGame::Board::MoveDIR::Down);//6,5
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
  
    board.move(1,{0,4},WarGame::Board::MoveDIR::Right);//0,5
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
    
	board.move(2, { 7,2 }, WarGame::Board::MoveDIR::Down);//6,2
	CHECK(board.has_soldiers(2));
	CHECK(board.has_soldiers(1));

    board.move(1,{0,6},WarGame::Board::MoveDIR::Right);//0,4
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
    
    board.move(2,{7,6},WarGame::Board::MoveDIR::Right);//7,7
    CHECK(board.has_soldiers(2));
    CHECK(board.has_soldiers(1));
}
...
TEST_CASE("Exceptions") {
	...
	CHECK_THROWS(board.move(1, { 0, 5 }, WarGame::Board::MoveDIR::Down));
	...
	CHECK_THROWS(board.move(2, { 0, 7 }, WarGame::Board::MoveDIR::Down));
	CHECK_THROWS(board.move(2, { 7, 4 }, WarGame::Board::MoveDIR::Up));
}
