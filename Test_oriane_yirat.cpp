...
TEST_CASE("Check Moves"){
    WarGame::Board p = fillBoard();
            ...
            CHECK_NOTHROW(p.move(1,{4,5},WarGame::Board::Up));//problem
            CHECK_NOTHROW(p.move(1,{5,0},WarGame::Board::Down));
//           CHECK_NOTHROW(p.move(1,{5,1},WarGame::Board::Right));//problem
 //           CHECK_NOTHROW(p.move(1,{5,2},WarGame::Board::Right));//problem
//            CHECK_NOTHROW(p.move(1,{5,5},WarGame::Board::Left));//problem
